...
/**
 * SponsorMatch — Marketing-Sektionen der Landingpage.
    ...
    >
      ...
      >
        <a href="#" style={{ display: "inline-flex", alignItems: "center" }}>
          ...
          <img src="/logo-wordmark.svg" alt="SponsorMatch" style={{ height: 30 }} className="sm-light-only" />
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src="/logo-wordmark-dark.svg" alt="SponsorMatch" style={{ height: 30 }} className="sm-dark-only" />
        </a>
        ...
        <div style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: 10 }}>
          ...
          >
            <Icon name="moon" size={18} className="sm-light-only" />
            <Icon name="sun" size={18} className="sm-dark-only" />
          </button>
          <Button variant="ghost" size="sm" className="sm-hide-sm">
            Anmelden
          </Button>
...
export function Testimonials() {
  const items = [
    ...
    },
    {
      name: "TSV Lindenau",
      role: "Amateurverein",
      text: "Als kleiner Verein hätten wir nie gedacht, einen Trikotsponsor zu finden. Über SponsorMatch lief es seriös und transparent.",
      rating: 4.5,
    },
  ];
  return (
  ...
  return (
    <footer style={{ background: "var(--navy-900)", color: "var(--navy-100)" }}>
      ...
      >
        <div>
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src="/logo-wordmark-dark.svg" alt="SponsorMatch" style={{ height: 30 }} />
