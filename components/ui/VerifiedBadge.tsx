...
/**
 * SponsorMatch — VerifiedBadge: Vertrauenssignal.
 * type: "verified" (Identität geprüft), "pro" (Premium), "secure" (sichere Zahlung).
 * Trust-Glyphen sind bewusst Inline-SVG (keine Icon-Abhängigkeit).
 */
  ...
  if (kind === "star")
    return (
      <svg {...common} fill="currentColor" stroke="none">
        <path d="M12 2.5l2.6 5.5 6 .8-4.4 4.2 1.1 6L12 16.9 6.7 19l1.1-6L3.4 8.8l6-.8z" />
      </svg>
    );
  return (
    <svg {...common}>
...
export function VerifiedBadge({ type = "verified", showLabel = true, size = "md", style, ...rest }: VerifiedBadgeProps) {
