...
/** SponsorMatch — Checkbox with label. Controlled or uncontrolled. */
export function Checkbox({
  label, description, checked, defaultChecked, disabled = false,
  ...
  return (
    <label htmlFor={cbId} style={{
      ...
      <span style={{ position: 'relative', display: 'inline-flex', flex: '0 0 auto', marginTop: description ? 2 : 0 }}>
        <input
          id={cbId} type="checkbox" checked={isControlled ? checked : undefined}
        ...
        <span style={{
          ...
          {on && (
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="var(--on-accent)" strokeWidth="3.4" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>
          )}
        </span>
      </span>
      {label && (
