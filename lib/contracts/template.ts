...
/**
 * SponsorMatch — Vertragsvorlage v1 (M5).
  ...
  return [
    {
      ...
      paragraphs: [
        ...
        "Die Identität beider Parteien ergibt sich aus den verifizierten SponsorMatch-Profilen zum Zeitpunkt der Zustimmung.",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        "Die Zahlung erfolgt über die SponsorMatch-Plattform: Der Sponsor zahlt die Gesamtvergütung sicher ins Escrow ein; die Auszahlung je Meilenstein erfolgt erst nach dessen Freigabe durch den Sponsor.",
      ],
    },
    {
